...
<div class="min-h-screen flex flex-col bg-surface-900 text-surface-50">
  <header class="p-6">
    <div class="accent-gradient rounded-3xl p-6 shadow-2xl text-center">
      <h1 class="text-3xl font-semibold text-white">SplitTogether</h1>
      <p class="text-white/80 mt-2">Fast, fair bill splitting for groups.</p>
    </div>
  </header>

  <main class="flex-1 px-6 pb-24 space-y-4">
    <div class="glass-card rounded-3xl p-6 space-y-3 text-center">
